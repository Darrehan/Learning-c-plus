...
template <class T>
arithimatic <T>::add() // do not write T in front of arithematic because it will automatically check
// what funtion is going to return template<T> is defined to this funtion it will do automatic conversion. 
{
    T c;
    c = a + b;
    return c;
